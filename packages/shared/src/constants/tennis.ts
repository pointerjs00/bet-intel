...
export const TENNIS_TOURNAMENTS: Record<string, TennisTournamentMetadata> = {
  ...
  // ── WTA Tournaments ──────────────────────────────────────────────────────────
  'Australian Open WTA': { country: 'Austrália', points: 2000 },
  'Roland Garros WTA': { country: 'França', points: 2000 },
  'Wimbledon WTA': { country: 'Inglaterra', points: 2000 },
  'US Open WTA': { country: 'EUA', points: 2000 },
  'WTA Finals': { country: 'Internacional', points: 1500 },
  'Billie Jean King Cup': { country: 'Internacional', points: 0 },
  'Indian Wells WTA': { country: 'EUA', points: 1000 },
  'Miami WTA': { country: 'EUA', points: 1000 },
  'Madrid WTA': { country: 'Espanha', points: 1000 },
  'Rome WTA': { country: 'Itália', points: 1000 },
  'Toronto WTA': { country: 'Canadá', points: 1000 },
  'Cincinnati WTA': { country: 'EUA', points: 1000 },
  'Beijing WTA': { country: 'China', points: 1000 },
  'Stuttgart WTA': { country: 'Alemanha', points: 500 },
  'Dubai WTA': { country: 'Emirados Árabes Unidos', points: 500 },
  'Doha WTA': { country: 'Qatar', points: 500 },
  'Eastbourne WTA': { country: 'Inglaterra', points: 250 },
  'Birmingham WTA': { country: 'Inglaterra', points: 250 },
  'Nottingham WTA': { country: 'Inglaterra', points: 250 },
  'Bad Homburg WTA': { country: 'Alemanha', points: 250 },
  'San José WTA': { country: 'EUA', points: 250 },
  'Guadalajara WTA': { country: 'México', points: 500 },
  'Wuhan WTA': { country: 'China', points: 1000 },
  'WTA 125': { country: 'Internacional', points: 125 },
  'WTA Challenger': { country: 'Internacional', points: 100 },
};
