...
export const TEAM_LOGOS: Record<string, string> = {
  ...
  'Bodo/Glimt':             TEAM_CDN(258),
  'Molde FK':               TEAM_CDN(248),
  'Rosenborg BK':           TEAM_CDN(252),
  'Brann':                  TEAM_CDN(249),
  'Viking FK':              TEAM_CDN(253),
  'Lillestrom SK':          TEAM_CDN(246),
  'Stromsgodset IF':        TEAM_CDN(255),
  'Stabak':                 TEAM_CDN(254),
  'Valerenga':              TEAM_CDN(256),
  'IK Start':               TEAM_CDN(260),
  'Tromso IL':              TEAM_CDN(257),
  ...
  'Oleksandriya':           TEAM_CDN(2285),
  'Vorskla Poltava':        TEAM_CDN(2284),
  'Metalist 1925':          TEAM_CDN(2286),
  'Chornomorets Odesa':     TEAM_CDN(2289),
  ...
  // Saudi Pro League
  'Al-Hilal':               TEAM_CDN(2939),
  'Al-Nassr':               TEAM_CDN(2940),
  'Al-Ittihad':             TEAM_CDN(2941),
  'Al-Ahli':                TEAM_CDN(2942),
  'Al-Ettifaq':             TEAM_CDN(2943),
  'Al-Shabab':              TEAM_CDN(2944),
  'Al-Taawoun':             TEAM_CDN(2945),
  'Al-Fateh':               TEAM_CDN(2946),
  'Al-Wehda':               TEAM_CDN(2947),
  'Al-Faisaly':             TEAM_CDN(2948),
  'Al-Qadsiah':             TEAM_CDN(14806),
  'Al-Hazm':                TEAM_CDN(2949),
  'Al-Raed':                TEAM_CDN(2950),
  'Al-Riyadh':              TEAM_CDN(2951),
  'Abha FC':                TEAM_CDN(2952),
  'Al-Khaleej':             TEAM_CDN(2953),
  // UAE Pro League
  ...
  'Santos Laguna':          TEAM_CDN(1361),
  'Club Toluca':            TEAM_CDN(1362),
  ...
  'Club Tijuana':           TEAM_CDN(1367),
  'FC Juarez':              TEAM_CDN(9628),
  'Club Leon':              TEAM_CDN(1368),
  'Necaxa':                 TEAM_CDN(1369),
