...
const MARKETS: MarketSeed[] = [
  ...
  { name: 'Resultado handicap', category: 'Handicap', sport: Sport.BASKETBALL },
  { name: 'Handicap', category: 'Handicap', sport: Sport.BASKETBALL },
  { name: 'Total de pontos', category: 'Pontos', sport: Sport.BASKETBALL },
  { name: 'Total de Pontos', category: 'Pontos', sport: Sport.BASKETBALL },
  { name: 'Total de pontos do Jogador', category: 'Pontos', sport: Sport.BASKETBALL },
  { name: 'Ressaltos', category: 'Especiais', sport: Sport.BASKETBALL },
  ...
  { name: 'Vencedor', category: 'Principal', sport: Sport.TENNIS },
  { name: 'Resultado correcto do encontro', category: 'Resultado', sport: Sport.TENNIS },
  { name: 'Resultado Correto do Encontro', category: 'Resultado', sport: Sport.TENNIS },
  { name: 'Total de jogos', category: 'Games', sport: Sport.TENNIS },
  ...
  { name: 'Handicap de jogos', category: 'Handicap', sport: Sport.TENNIS },
  { name: 'Total de Sets', category: 'Sets', sport: Sport.TENNIS },
  { name: 'Jogador ganha um set', category: 'Sets', sport: Sport.TENNIS },
  { name: 'Tiebreak no Encontro', category: 'Especiais', sport: Sport.TENNIS },

  // ── Hockey ──
  { name: 'Resultado', category: 'Principal', sport: Sport.HOCKEY },
  ...
  { name: 'Jogador marca um Touchdown', category: 'Especiais', sport: Sport.AMERICAN_FOOTBALL },
