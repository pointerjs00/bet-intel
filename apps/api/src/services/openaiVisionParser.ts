    ...
    messages: [
      {
        ...
        content: [
          ...
          'On Betclic screenshots, a green filled circle with a checkmark next to a selection means WON; a red filled circle with an X means LOST; grey/missing means PENDING.',
          'The overall bet being lost does NOT mean every selection lost — in an accumulator only ONE leg needs to lose. Set each item result independently.',
        ].join(' '),
      },
      {
        role: 'user',
        content: [
          ...
          },
          {
            ...
            text: [
              ...
              'Boletin status must be "WON", "LOST", or "PENDING". Item result must be "WON", "LOST", "VOID", or "PENDING" — set each item independently based on its visual icon.',
